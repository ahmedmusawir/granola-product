...
<div class="custom_font_holder titlesubhead" >Our Friends & Our Partners Making The World A Better Place</div>
	<div class="container"<?php if($background_color != "") { echo " style='background-color:". $background_color ."'";} ?>>
		<div class="container_inner default_template_holder">
<a class="idx" href="http://www.1800granola.com/index/">Index</a>
